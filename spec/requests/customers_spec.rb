...
RSpec.describe 'Customers API', type: :request do
  ...
  describe 'POST /customers' do
    # valid payload
    let(:valid_attributes) { { first_name: 'Learn Elm', last_name: 'Learn Elm' } }
    ...
    context 'when the request is valid' do
      ...
      it 'creates a customer' do
        ...
        expect(json['last_name']).to eq('Learn Elm')
      end
    ...
    context 'when the request is invalid' do
      before { post '/customers', params: { last_name: 'Foobar' } } # last name only
